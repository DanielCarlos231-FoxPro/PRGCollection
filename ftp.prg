...
ftp = CreateObject("clsFtp")
strHost		= ""	&& DNS or IP Address 
strUser		= ""	&& User Name
strPassword	= ""	&& Password
ftp.FtpConnect(strHost, strUser, strPassword)
ftp.GetFromFtp("RemotePath", "LocalPathToDownloadFile")
MessageBox(ftp.ErrMsg)
